...
const MovieDetails = () => {
  ...
  const { axios, shows, getToken, user, fetchFavMovies, favouriteMovies, image_base_url} = useAppContext()
    ...
    <div className='px-6 md:px-16 lg:px-40 pt-30 md:pt-50'>
      ...
      <div className='flex flex-col md:flex-row gap-8 max-w-6xl mx-auto'>
        ...
        <div className='relative flex flex-col gap-3'>
          ...
          <p className='text-gray-400 mt-2 text-sm'>{show.movie.overview} </p>
      ...
      <div className='flex justify-center mt-20'>
          <button onClick={()=> {navigate('/movies'); scrollTo(0,0)}} className='px-10 py-3 text-sm bg-primary hover:bg-primary-dull transition rounded-md font-medium cursor-pointer active:scale-95'>Show More</button>
      </div>
    </div>
  ) : (
    <Loading />
